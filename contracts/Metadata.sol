...
contract Metadata is Ownable {
    ...
    /**
    @param category number between 0 - 8
    @param traits array of objects with two pairs with name & image keys

    you have to call this function 8 times to upload all the traits
     */

    function uploadTraits(uint8 category, uint8 i, Trait calldata traits)
        public
        onlyOwner
    {
        
        traitData[category][i] = Trait(traits.name, traits.image);
